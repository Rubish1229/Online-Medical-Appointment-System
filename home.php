...
<button type="button" class="btn btn-primary"><a href="samplesignup.php">Get started</a>  </button>
    ...
    <div class="steps">
        <div class="steps-div">
            <span>
                <h4>Access healthcare service anytime from anywhere with SWASTHYA </h4>
    ...
    <div class="departments">
        <div class="departmentfirst ">
            <h4>Departments <br> <p style="font-size: 18px; font-weight: normal; margin-top: 5px;">Identify and treat your symptoms instantly</p></h4>
            <a href="" class="borderline">View more <i class="fa-solid fa-angles-right"></i></a>
        </div>
  ...
  <h4>Hospitals<br> <p style="font-size: 18px; font-weight: normal; margin-top: 5px;">Experienced medical practitioners available here.</p></h4>
            <a href="" class="borderline">View more <i class="fa-solid fa-angles-right"></i></a>
</div>
  <div class="slider-container">
   ...
   <div class="doctor-section">
    <div class="doctorfirst">
  <h4>Appointments With Top Doctors <br> <p style="font-size: 18px; font-weight: normal; margin-top: 5px;">Experienced medical practitioners available here.</p></h4>
            <a href="" class="borderline">View more <i class="fa-solid fa-angles-right"></i></a>
</div>
  <div class="slider-container">
 ...
 <div class="healthpackage-section">
  ...
  <h4>Health Packages<br> <p style="font-size: 18px; font-weight: normal; margin-top: 5px;">Offering complete checkups, accurate diagnostics, and personalized care at affordable prices.</p></h4>
            <a href="" class="borderline">View more <i class="fa-solid fa-angles-right"></i></a>
</div>
...
<section class="package-section">
    ...
    <div class="about">
        <div class="about1 all" id="about1"><p>What is SWASTHYA?</p></div>
        <div class="about2 all" id="about2"><p>How do I book?</p></div>
        <div class="about1 all" id="about3"><p>What are the features available?</p></div>
        <div class="about1 all" id="about4"><p>How to cancel?</p></div>
        <div class="about1 all" id="about5"><p>How do I pay?</p> </div>
        <div class="about1 all" id="about6"><p>Is it safe?</p></div>
    </div>

    <div class="lastpart">
      <div class="list1 list">
        <ul><li><a href=""><h6>QUICK LOGIN</h6></a></li>
       ...
       <div class="list2 list">
        <ul><li><a href=""><h6>QUICK LINKS</h6></a></li>
       ...
       <div class="list3 list">
        <ul><li><a href=""><h6>GET IN TOUCH</h6></a></li>
            <li><a href=""> <i class="fa-solid fa-location-dot fa-beat-fade"></i> &nbsp Chabahil, Kathmandu </a></li>
            <li><a href=""><i class="fa-solid fa-phone fa-shake"> &nbsp</i>+977-9876542314 </a></li>
            <li><a href=""> <i class="fa-solid fa-envelope fa-bounce"></i>&nbsp digitalswasthya@gmail.com </a></li>
        </ul>
      </div>
  ...
  <ul>
    <li><a href=""><h6>FOLLOW US ON</h6></a></li>
  </ul>

  <div class="social-icons">
    <span><a href="" class="social" style="color: #1877F2;"><i class="fa-brands fa-facebook"></i></a></span>
    <span><a href="" class="social"><i class="fa-brands fa-instagram"></i></a></span>
    <span><a href="" class="social" style="color: black;"><i class="fa-brands fa-x-twitter"></i></a></span>
  </div>
